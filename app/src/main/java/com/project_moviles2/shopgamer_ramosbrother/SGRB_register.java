...
public class SGRB_register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgrb_register);
        ...
        jrbAnfitrion=findViewById(R.id.rbvendedor);
        jrbInvitado=findViewById(R.id.rbusuario);
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(SGRB_register.this);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SGRB_register.this,"no funciona esta mierda",Toast.LENGTH_SHORT).show();
